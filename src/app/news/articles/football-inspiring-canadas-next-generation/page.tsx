    ...
    <main style={ maxWidth: 760, margin: "0 auto", padding: "24px 16px 120px" }>
      ...
      <div style={ marginBottom: 20 }>
        <div style={ marginBottom: 10, display: "flex", gap: 8, flexWrap: "wrap" }>
          <span style={ background: "rgba(37,99,235,0.1)", color: "#2563eb", fontSize: 11, fontWeight: 700, padding: "3px 10px", borderRadius: 20 }>
      ...
      <article style={ color: "#374151", lineHeight: 1.85, fontSize: 15.5 }>
        ...
        <Quote
          text="When the World Cup is in your city, football stops being something on a screen. It becomes something you can touch."
          cite="Community coach, east Toronto"
        />
        ...
        <Figure
          src={`${IMG}/04-coaching-moment.jpg`}
          alt="Radin Hajipour, young football captain in Toronto, wearing the captain's armband"
          caption="Radin Hajipour — young captain, Toronto, Canada. Responsibility, focus, and pride in every step."
        />

        {/* Q&A */}
        <div style={
          background: "#f8fafc", border: "1px solid #e2e8f0",
          borderRadius: 14, padding: "20px", margin: "24px 0",
        }>
          ...
          {[
            ...
            <div key={i} style={ marginBottom: i < arr.length - 1 ? 16 : 0, paddingBottom: i < arr.length - 1 ? 16 : 0, borderBottom: i < arr.length - 1 ? "1px solid #e2e8f0" : "none" }>
        ...
        <Figure
          src={`${IMG}/03-girls-training.jpg`}
          alt="Radin Hajipour wears a Canadian flag captain's armband during youth football training in Toronto"
          caption="Captain's armband. Community clubs across the GTA are nurturing young captains who wear the armband with pride."
        />
        ...
        <Quote
          text="We tell them: Davies was once a kid on a pitch like this. The difference is work — and believing the work matters."
          cite="Youth programme director, Toronto"
        />

        <H2>Toronto&apos;s parks become classrooms</H2>

        <Figure
          src={`${IMG}/05-bmo-field.jpg`}
          alt="Two young footballers pause on a grass field in a Toronto park"
          caption="City parks, city dreams. Before BMO Field hosts Canada's opener, thousands of children learn the game on pitches tucked between condos, schools, and tree lines."
        />
        ...
        <Figure
          src={`${IMG}/06-youth-team.jpg`}
          alt="A young player in navy and orange kit moves across a Toronto grass field in golden-hour light"
          caption="Golden hour. Football in Toronto is a meeting place — World Cup year makes that visible on every corner pitch."
        />
        ...
        <Figure
          src={`${IMG}/09-family-support.jpg`}
          alt="A young football captain stands with a family member on an artificial turf pitch in Toronto"
          caption="Family support remains one of the most important influences in youth football across Canada."
        />

        <p style={ marginBottom: 16 }>On every community pitch in Canada, there is a story that does not always make the highlight reel: the parent who drives across the city after work, the sibling who waits on the sideline, the family that rearranges weekends so a child can train, play, and grow.</p>

        <H2>What happens after the final whistle?</H2>

        <Figure
          src={`${IMG}/07-celebration.jpg`}
          alt="A young footballer drives a ball across a Toronto grass field in late-afternoon sunlight"
          caption="Joy as infrastructure. The work on community pitches is real — organisers hope 2026 leaves more than memories."
        />

        <Figure
          src={`${IMG}/08-turf-session.jpg`}
          alt="A young player in a pink training top walks across an artificial turf pitch in Toronto"
          caption="Every season. Snow on the bleachers, ball at the feet — football in Canada does not wait for perfect weather."
        />

        <Quote
          text="The World Cup lasts a month. Inspiration can last a lifetime — if we build for the children who are eight years old today."
          cite="Grassroots organiser, Greater Toronto Area"
        />
      ...
      <div style={ display: "flex", gap: 10, flexWrap: "wrap" }>
        <Link href="/news/articles" style={ padding: "8px 16px", background: "rgba(37,99,235,0.1)", color: "#2563eb", borderRadius: 8, textDecoration: "none", fontWeight: 700, fontSize: 13 }>← All Articles</Link>
