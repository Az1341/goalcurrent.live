  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "24px 16px 120px" }}>
      ...
      <nav style={{ fontSize: 12, color: "#94a3b8", marginBottom: 16 }}>
        ...
        {" › "}
        <strong style={{ color: "#0f172a" }}>{article.title.substring(0, 40)}…</strong>
      </nav>

      {/* Hero */}
      <div style={{
        background: "linear-gradient(135deg, rgba(37,99,235,0.06) 0%, #f8fafc 100%)",
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, color: "#0f172a", lineHeight: 1.25, marginBottom: 12 }}>
          {article.title}
        </h1>
      ...
      <article
        ...
        dangerouslySetInnerHTML={{ __html: article.content
          .replace(/<h2>/g, '<h2 style="font-size:18px;font-weight:800;color:#0f172a;margin:28px 0 10px;padding-bottom:8px;border-bottom:2px solid #2563eb;">')
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 40 }}>
        ...
        <Link href="/worldcup2026" style={{
          padding: "8px 16px", background: "#2563eb",
          color: "#fff", borderRadius: 8, textDecoration: "none",
          fontWeight: 700, fontSize: 13
        }}>🌍 World Cup 2026</Link>
        <Link href="/premier-league" style={{
          padding: "8px 16px", background: "rgba(37,99,235,0.1)",
          color: "#2563eb", borderRadius: 8, textDecoration: "none",
          fontWeight: 700, fontSize: 13
        }}>🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League</Link>
      </div>
