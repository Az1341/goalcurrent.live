...
export const BEIRANVAND_FEATURE: EditorialArticle = {
  ...
  relatedLinks: [
    { href: "/worldcup2026/standings", label: "World Cup 2026 standings" },
    { href: "/worldcup2026/groups/g", label: "Group G fixtures" },
  ...
  sections: [
    {
      ...
      image: {
        label: "[PHOTO – Beiranvand with Iran]",
        alt: "Alireza Beiranvand in Iran national team kit at World Cup 2026",
        caption: "Alireza Beiranvand has been Iran's first-choice goalkeeper across multiple World Cup cycles.",
      },
    },
    {
      id: "growing-up",
      heading: "Growing Up In Iran",
      paragraphs: [
    ...
    {
      id: "journey",
      heading: "The Journey To Professional Football",
      paragraphs: [
    ...
    {
      id: "persepolis",
      heading: "Persepolis And Domestic Success",
      paragraphs: [
    ...
    {
      id: "number-one",
      heading: "Becoming Iran's Number One",
      paragraphs: [
    ...
    {
      id: "long-throws",
      heading: "The Famous Long Throws",
      paragraphs: [
    ...
    {
      id: "belgium",
      heading: "Belgium Match Analysis",
      paragraphs: [
      ...
      image: {
        label: "[PHOTO – Key save against Belgium]",
        alt: "Alireza Beiranvand making a save during Iran vs Belgium at World Cup 2026",
        caption: "Beiranvand's positioning and shot-stopping kept Belgium from breaking through in open play.",
      },
    },
    {
      id: "motm",
      heading: "Why He Was Man Of The Match",
      paragraphs: [
    ...
    {
      id: "meaning",
      heading: "What He Means To Iranian Football",
      paragraphs: [
      ...
      image: {
        label: "[PHOTO – Iran national team celebration]",
        alt: "Iran national team players celebrate after the draw with Belgium",
        caption: "Iran's point against Belgium gave Group G an early lift — and Beiranvand was at the centre of it.",
      },
    },
    {
      id: "ambitions",
      heading: "Iran's World Cup Ambitions",
      paragraphs: [
